  ...
  private:
    ...
    */
    ...
    scan_number()  // lgtm [cpp/use-of-goto] `goto` is used in this function to implement the
                   ...
                   // intermediate state, 1 byte of the input is appended to the token_buffer
                   // vector, and only the already initialized variables token_buffer, number_type,
                   // and error_message are manipulated.
    {
